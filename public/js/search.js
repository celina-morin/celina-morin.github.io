(() => {
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\krisk\!fuse@v7.0.0+incompatible\dist\fuse.js
  var require_fuse = __commonJS({
    "ns-hugo:C:\\Users\\Siera\\AppData\\Local\\hugo_cache\\modules\\filecache\\modules\\pkg\\mod\\github.com\\krisk\\!fuse@v7.0.0+incompatible\\dist\\fuse.js"(exports, module) {
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\keyboard.ts
  var Keyboard = class {
    keys = {};
    events = [];
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\navigator.ts
  var Navigator = class {
    modal() {
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\i18n-js@v0.2.1\assets\mods\i18n\translator.ts
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\i18n.ts
  var i18n = void 0;
  var init = () => {
    return new Promise((resolve) => {
      const lang = document.documentElement.getAttribute("lang") ?? params_default.lang;
      fetch(params_default.locales[lang]).then((resp) => resp.json()).then((messages) => {
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\engine.ts
  ...
  var Engine = class {
    ...
    init() {
      ...
      for (const i in params_default.indices) {
        const index = params_default.indices[i];
    ...
    getKeys() {
      ...
      const keys = [
        { name: "title", weight: params_default.key_weights.title },
        { name: "summary", weight: params_default.key_weights.summary },
        { name: "headings.title", weight: params_default.key_weights.headings },
        { name: "lang", weight: params_default.key_weights.lang },
        { name: "year", weight: params_default.key_weights.year }
      ];
      if (params_default.index_content) {
        keys.push({ name: "content", weight: params_default.key_weights.content });
      }
      for (const taxonomy in engine.taxonomies) {
        keys.push({ name: taxonomy, weight: params_default.key_weights.taxonomies });
      }
      this.keys = keys;
      return this.keys;
    }
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\historiographer.ts
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\form.ts
  var Form = class {
  ...
  <div class="search-form-meta">
    ...
    renderLanguage() {
      if (Object.keys(engine_default.langs).length < 2) {
        return "";
      }
      const lang = document.documentElement.getAttribute("lang") ?? "";
      let label = translate("all");
      let options = `<li class="search-dropdown-item${lang ? "" : " active"}" data-value="">${label}</li>`;
      for (const langCode in engine_default.langs) {
        const langName = engine_default.langs[langCode];
        let className = "";
        if (langCode === lang) {
          className = " active";
          label = langName;
  ...
  <div class="search-dropdown-body">
    ...
    renderSorting() {
      if (engine_default.langs.length < 2) {
        return "";
      }
  ...
  <div class="search-dropdown-body">
    ...
    renderYears() {
      if (engine_default.years.length === 0) {
        return "";
      }
      let items = "";
      for (const year of engine_default.years) {
    ...
    renderTaxonomies() {
      let v = "";
      for (const name in engine_default.taxonomies) {
        v += this.renderTaxonomy(name, engine_default.taxonomies[name]);
      }
      return v;
    }
...
<button class="search-panel-action search-expand-toggle${params_default.expand_results_meta ? " active" : ""}" title="Expand">
    ...
    getTaxonomies() {
      const v = {};
      for (const taxonomy in engine_default.taxonomies) {
        const terms = [];
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\spinner.ts
  var Spinner = class {
    constructor(ele) {
      this.ele = ele;
    }
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\renderer.ts
  var Renderer = class {
    ...
    getLang() {
      if (!this.lang) {
        this.lang = document.documentElement.getAttribute("lang") ?? params_default.lang;
      }
      return this.lang;
    }
    clean() {
    ...
    url(page, url) {
      return engine_default.getBaseURL(page.site) + url;
    }
    taxonomies(page) {
      let v = "";
      for (const key of Object.keys(engine_default.taxonomies)) {
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\shortcuts.ts
  var Navigate = () => {
    return {
      kbds: ["\u2191", "\u2193"],
...
<span class="search-shortcut-action">${shortcut["action"]}</span>
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\modal.ts
  var searchShortcut = () => {
    return {
  ...
  // ns-hugo:C:\Users\Siera\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.19.0\assets\search\js\search.ts
  var Search = class {
    container;
    form;
    shortcuts;
